...
def train(args):
    ...
    training_state_path = os.path.join(train_config['task_name'], 'training_state.pth')
    ...
    for epoch_idx in range(start_epoch, num_epochs):
        ...
        # Save model and discriminator weights
        ...
        torch.save(training_state, os.path.join(train_config['task_name'], 'training_state.pth'))
    print('Done Training...')
